package hello.cluebackend.domain.assignment.assignment.domain;
...
public class QAssignment extends EntityPathBase<Assignment> {
    ...
    public final ListPath<Submission, hello.cluebackend.domain.assignment.submission.domain.QSubmission> submissions = this.<Submission, hello.cluebackend.domain.assignment.submission.domain.QSubmission>createList("submissions", Submission.class, hello.cluebackend.domain.assignment.submission.domain.QSubmission.class, PathInits.DIRECT2);
