...
public class QSubmissionAttachment extends EntityPathBase<SubmissionAttachment> {
    ...
    private static final long serialVersionUID = 1669741815L;
    ...
    public final hello.cluebackend.domain.assignment.participation.domain.QSubmission submission;
    ...
    public QSubmissionAttachment(Class<? extends SubmissionAttachment> type, PathMetadata metadata, PathInits inits) {
        ...
        this.assignment = inits.isInitialized("assignment") ? new hello.cluebackend.domain.assignment.management.domain.QAssignment(forProperty("assignment"), inits.get("assignment")) : null;
        this.submission = inits.isInitialized("submission") ? new hello.cluebackend.domain.assignment.participation.domain.QSubmission(forProperty("submission"), inits.get("submission")) : null;
