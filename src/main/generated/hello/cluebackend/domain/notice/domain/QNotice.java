...
public class QNotice extends EntityPathBase<Notice> {
    ...
    public final ListPath<hello.cluebackend.domain.noticedocument.domain.NoticeDocument, hello.cluebackend.domain.noticedocument.domain.QNoticeDocument> noticeDocuments = this.<hello.cluebackend.domain.noticedocument.domain.NoticeDocument, hello.cluebackend.domain.noticedocument.domain.QNoticeDocument>createList("noticeDocuments", hello.cluebackend.domain.noticedocument.domain.NoticeDocument.class, hello.cluebackend.domain.noticedocument.domain.QNoticeDocument.class, PathInits.DIRECT2);
