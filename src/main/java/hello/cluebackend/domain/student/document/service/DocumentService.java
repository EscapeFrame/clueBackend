package hello.cluebackend.domain.student.document.service;
...
import hello.cluebackend.domain.student.directory.domain.repository.DirectoryRepository;
import hello.cluebackend.domain.student.document.domain.Document;
import hello.cluebackend.domain.student.document.domain.repository.DocumentRepository;
